              ...
              <div className="flex items-center gap-4">
                ...
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    ...
                    {user.isVerified && (
                      <div className="inline-flex items-center justify-center bg-gradient-to-b from-[#1877F2] to-[#166FE5] text-white rounded-sm w-5 h-5 flex-shrink-0 shadow-lg border border-[#1877F2] relative overflow-hidden">
