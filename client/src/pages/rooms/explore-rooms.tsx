      ...
      <div className="flex-1 ml-64">
        ...
        <div className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 p-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-white">🌍 Explore Rooms</h1>
              <p className="text-gray-500 dark:text-gray-400">Discover new rooms and communities</p>
            </div>
          </div>
        </div>
