          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md flex flex-col items-center text-center">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-4">Monday to Friday, 9am to 5pm</p>
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md flex flex-col items-center text-center">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-4">Visit our headquarters</p>
              ...
              <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md">
                ...
                <div className="mt-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <h4 className="font-medium">How can I report a bug?</h4>
                      <p className="text-gray-600 dark:text-gray-300 text-sm mt-1">
                    ...
                    <div>
                      <h4 className="font-medium">Do you offer affiliate programs?</h4>
                      <p className="text-gray-600 dark:text-gray-300 text-sm mt-1">
                    ...
                    <div>
                      <h4 className="font-medium">How can I suggest a new game?</h4>
                      <p className="text-gray-600 dark:text-gray-300 text-sm mt-1">
