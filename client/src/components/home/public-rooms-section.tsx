                ...
                <div className="flex items-center justify-between">
                  <CardTitle className="flex items-center gap-2 text-lg">
                    ...
                    {room.owner.isVerified && (
                      <div className="inline-flex items-center justify-center bg-gradient-to-b from-[#1877F2] to-[#166FE5] text-white rounded-sm w-4 h-4 flex-shrink-0 ml-1.5 shadow-lg border border-[#1877F2] relative overflow-hidden">
